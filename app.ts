...
console.log(bar('fergrb'))




const arr : (number | string) [] = [1, 3,'cat']
*/



/*
//enum -- перечисление, хранение однотипных данных
...
////////////////////////////////////////////////типизировать разные объекты (d?: number ---необязательный объект)
